...
public class MainActivity extends AppCompatActivity {
    ...
    private void getForecast(double latitude, double longitude) {
        String apiKey = "b9e74c9afaf9ed294c35d7cac1f5dcda";
        ...
        if(isNetworkAvailable()) {
            ...
            //call.execute(request) is for Sync method which replaced with call.enqueue which is Async method
    ...
    private Hour[] getHourlyForecast(String jsonData) throws JSONException {
        ...
        JSONArray data = hourly.getJSONArray("data"); //introduction JSONArray
